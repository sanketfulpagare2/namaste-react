...
const Items = ({data,vegfilter,CDN_URL}) => {
  ...
  return (
    ...
    {((vegfilter==="VEG"?data?.card?.info?.itemAttribute.vegClassifier==="VEG":true ) && <div  className=' border-b-2 m-2  p-5 flex border-gray-600 dark:border-gray-600 text-left'>
